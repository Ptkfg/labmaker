# import_equipamentos_tecnicos.py
from app import app, db
from models_equipamentos import EquipamentosTi
...
CSV_PATH = os.path.join("data", "cadastro_equipamentos_ti.csv")  # ajuste se preciso
ENCODING = "latin1"
SEP = ","
